...
const PCMVContainer: React.FC<PCMVContainerProps> = ({ title1, title2 }) => {
  const [aerialFile, setAerialFile] = useState<string>("karawatha_submap_aerial_2.pcd");
  const [groundFile, setGroundFile] = useState<string>("karawatha_submap_gnd_2.pcd");
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.modelViewers} style={{ flexDirection: isSmallScreen ? "column" : "row" }}>
